...
<html lang="en">
  <head>
    ...
    <title>Ndalem Smile Coffe</title>
  </head>
  <body>
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">Ndalem Smile Coffe</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Ndalem</strong> Smile Coffe</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Ndalem Smile Coffe</h3>
          <h5>Bantul, Yogyakarta
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2022 -  Designed by Mukti&Rivaldo</p>
          </div>
          </div>
